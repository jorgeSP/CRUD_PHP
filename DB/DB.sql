...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `identificador` varchar(9) COLLATE utf8_spanish_ci NOT NULL,
  `genero` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `fechasalida` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
  `duracion` int(2) NOT NULL,
  `ciudad` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `lenguaje` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `aficion` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`user`)
